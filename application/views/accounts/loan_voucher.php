...
?>
<div class="row-fluid">
    <form action="<?php echo site_url('accounts/loanvoucher');?>" class="form-horizontal no-margin" method="POST">
        <div class="span12">
            <div class="widget">
                <div class="widget-header">
                    <div class="title">
                        <?php widgetHeader(); ?> Loan Voucher Form
                    </div>
                </div>
                ...
                <div class="widget-body">
                    ...
                    <div class="form-actions">
                        ...
                        <button type="submit" class="btn btn-primary" onclick="return confirm('Are you sure? This will be adjusted from Central Depot Cash')"> Loan Voucher</button>
