...
?>
<div class="row-fluid">
    <form action="<?php echo site_url('accounts/loanopening');?>" class="form-horizontal no-margin" method="POST">
        <div class="span12">
            <div class="widget">
                <div class="widget-header">
                    <div class="title">
                        <?php widgetHeader(); ?> Loan Opening Balance
                    </div>
                </div>
                ...
                <div class="widget-body">
                    ...
                    <div class="form-actions">
                        ...
                        <button type="submit" class="btn btn-primary"> Loan Opening Balance</button>
