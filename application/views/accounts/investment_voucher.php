...
?>
<div class="row-fluid">
    <form action="<?php echo site_url('accounts/investmentvoucher');?>" class="form-horizontal no-margin" method="POST">
        <div class="span12">
            <div class="widget">
                <div class="widget-header">
                    <div class="title">
                        <?php widgetHeader(); ?> Investment Voucher Form
                    </div>
                </div>
                ...
                <div class="widget-body">
                    ...
                    <div class="form-actions">
                        ...
                        <button type="submit" class="btn btn-primary" onclick="return confirm('Are you sure? This will be deposited in Central Depot')"> Loan Voucher</button>
