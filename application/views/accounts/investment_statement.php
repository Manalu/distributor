    ...
    <div class="span12">
        <div class="widget">
            <div class="widget-header">
                <div class="title">
                    <?php widgetHeader(); ?> Business Investment Statement
                </div>
            </div>
                    ...
                    <table class="table table-bordered table-condensed table-hover table-striped">
                        ...
                        <tbody id="loan_statement">
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    <a href="<?php echo site_url('accounts/investmentledger?sess_auth=' . md5('Ymshis') . '&func=loan_statement&cat=accounts&voucher=' . rand(1, 100) . '&clopier=' . rand(1, 10) . '&user=' . $balance->user_id . '&max=' . $balance->balance . '&trans_type=2'); ?>">
