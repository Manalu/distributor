    ...
    <div class="span12">
        <div class="widget">
            <div class="widget-header">
                <div class="title">
                    <?php widgetHeader(); ?> Loan Opening Balance Refund
                </div>
            </div>
            ...
            <div class="widget-body">
                <form action="<?php echo site_url('accounts/loanrefund'); ?>" class="form-horizontal" method="POST">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls controls-row">
                            <input type="number" name="amount" id="amount" placeholder="Return Amount" required="required" class="span12" max="<?php echo $balance; ?>" min="1" step="any"  />
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="form-actions">
                        ...
                        <button type="submit" class="btn btn-primary" onclick="return confirm('Are you sure? This will be deposited in Central Depot')"> Loan Deposit</button>
