...
?>
<div class="row-fluid">
    <form action="<?php echo site_url('accounts/investmentopening');?>" class="form-horizontal no-margin" method="POST">
        <div class="span12">
            <div class="widget">
                <div class="widget-header">
                    <div class="title">
                        <?php widgetHeader(); ?> Investment Opening Balance
                    </div>
                </div>
                ...
                <div class="widget-body">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls controls-row">
                            <input type="number" name="amount" id="amount" placeholder="Amount" required="required" class="span12" min="0" step="any"  />
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="form-actions">
                        <input type="hidden" name="trigger" value="investmentdeposit" />
                        <button type="submit" class="btn btn-primary"> Investment Opening Balance</button>
