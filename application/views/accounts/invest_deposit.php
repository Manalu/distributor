...
?>
<div class="row-fluid">
    <form action="<?php echo site_url('accounts/investdeposit');?>" class="form-horizontal no-margin" method="POST">
        <div class="span12">
            <div class="widget">
                <div class="widget-header">
                    <div class="title">
                        <?php widgetHeader(); ?> Investment Deposit Form
                    </div>
                </div>
                ...
                <div class="widget-body">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls controls-row">
                            <input type="number" name="amount" id="amount" placeholder="Loan Amount" required="required" class="span12"  />
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="form-actions">
                        <input type="hidden" name="trigger" value="loandeposit" />
                        <button type="submit" class="btn btn-primary" onclick="return confirm('Are you sure? This will be deposited in Central Depot')"> Investment Deposit</button>
