    ...
    <div class="span12">
        <div class="widget no-margin">
            <div class="widget-header">
                <div class="title">
                    <?php widgetHeader(); ?> Search Customer List
                </div>
            </div>
            ...
            <div class="widget-body">
                ...
                <div class="span12 center-align-text">
                    <button type="button" class="btn btn-primary" id="customer_list_search_button">Search Customer Details</button>
                </div>
                <div class="clearfix"></div>
            </div>
            <div id="printable">
                        ...
                        <tbody id="customer_list_body">
                            ...
                            <tr>
                                ...
                                <td class="center-align-text noprint">
                                    <a href="<?php echo site_url("clients/ledger?func=details&cat=clients&mod=admin&sess_auth=" . md5(date("Ymdhis")) . "&remote=" . md5("autosol") . "&cl_id=" . $clnts->cl_id);?>">
                                        <i class="icon-profile"></i>
                                    </a>
                                </td>
                                <?php if($role == 3) { ?>
                                <td class="center-align-text noprint">
                                    <a href="<?php echo site_url("clients/update?func=update&cat=clients&mod=admin&sess_auth=" . md5(date("Ymdhis")) . "&remote=" . md5("autosol") . "&cl_id=" . $clnts->cl_id);?>">
                                        <i class="icon-edit"></i>
                                    </a>
                                </td>
                                <td class="center-align-text noprint">
                                    <a href="<?php echo site_url("clients/adjust?func=adjust&cat=clients&mod=admin&sess_auth=" . md5(date("Ymdhis")) . "&remote=" . md5("autosol") . "&cl_id=" . $clnts->cl_id);?>">
...
<script type="text/javascript">
    $("#customer_list_search_button").click(function(){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('clients/search_customer_list'); ?>",
