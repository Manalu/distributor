                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="center-align-text noprint">
                                    <a title="View Details" style="cursor: pointer;" onclick="viewDetailedInvoice('<?php echo $invoices->InvoiceId; ?>', '<?php echo $clid; ?>', '<?php echo $invoices->invtype; ?>')">
...
<script>
    ...
    function viewDetailedInvoice(invoiceid, client, invtype){
        jQuery .ajax({
            type: "POST",
            url: "<?php echo site_url('dsr/invoicedetails'); ?>",
