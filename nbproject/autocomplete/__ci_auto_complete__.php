 ...
 * @property CI_Zip $zip
 * @property accountsmodel $accountsmodel
 * @property medicinemodel $medicinemodel
 * @property suppliermodel $suppliermodel
 * @property settingsmodel $settingsmodel
 * @property ordermodel $ordermodel
 * @property salesmodel $salesmodel
 ...
 * @property compexemodel $compexe
 * @property clientsmodel $clients
 * @property loginmodel $login
 * @property recovermodel $recover
 * @property invoicemodel $invoice
 * @property ordermodel $order
 * @property settingsmodel $settings
 * @property typemodel $type
 * @property storemodel $store
 * @property accountsmodel $accounts
 * @property salesmodel $sales
